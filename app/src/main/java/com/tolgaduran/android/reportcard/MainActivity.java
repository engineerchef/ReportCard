...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ReportCard weather_data[] = new ReportCard[]
                {
                        new ReportCard(R.mipmap.ic_launcher, "Linear Algebra" , "A"),
                        new ReportCard(R.mipmap.ic_launcher, "Data Engineering" , "B"),
                        new ReportCard(R.mipmap.ic_launcher, "English" , "D"),
                        new ReportCard(R.mipmap.ic_launcher, "Turkish" , "A+"),
                        new ReportCard(R.mipmap.ic_launcher, "Algorithm" , "C"),
                        new ReportCard(R.mipmap.ic_launcher, "Fuzzy Logic Systems" , "B")
                };
